...
<template>
  <div class="product-item">
    ...
    <div class="product-details mt-2">
      ...
      <div class="product-button pt-2 flex items-center gap-2">
        <button class="bg-white p-2 rounded-xl shadow hover:bg-yellow-400 hover:text-white transition duration-300">
        ...
        <button class="bg-white p-2 rounded-xl shadow flex-1 flex justify-center items-center gap-3 hover:bg-yellow-400 hover:text-white transition duration-300">
